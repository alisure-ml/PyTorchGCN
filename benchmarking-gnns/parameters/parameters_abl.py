...
class Parameters(object):
    ...
    def __init__(self, dataset, model_name, dataset_name, out_dir,
                 batch_size, use_gpu, gpu_id, is_sgd=False, epochs=100, seed=41):
    ...
    def is_mnist(self):
        return self.dataset_name == "MNIST"
...
class ParametersGCN(Parameters):
    ...
    def __init__(self, dataset, model_name, dataset_name, out_dir, batch_size, use_gpu, gpu_id):
        ...
        ##########################################################################
        self.L = 3 if self.is_mnist() else 4
        self.hidden_dim = 64 if self.is_mnist() else 128
        self.out_dim = 64 if self.is_mnist() else 128
        self.residual = True
        self.readout = "mean"
        self.in_feat_dropout = 0.0
        self.dropout = 0.0
...
class ParametersGAT(Parameters):
    ...
    def __init__(self, dataset, model_name, dataset_name, out_dir, batch_size, use_gpu, gpu_id):
        ...
        ##########################################################################
        self.L = 3 if self.is_mnist() else 4
        self.hidden_dim = 64 // 8 if self.is_mnist() else 128 // 8
        self.out_dim = 64 if self.is_mnist() else 128
        self.residual = True
        self.readout = "mean"
        self.n_heads = 8
...
class ParametersDiffPool(Parameters):
    ...
    def __init__(self, dataset, model_name, dataset_name, out_dir, batch_size, use_gpu, gpu_id):
        ...
        self.L = 3 if self.is_mnist() else 4
        self.hidden_dim = 64 if self.is_mnist() else 128
        self.embedding_dim = 64 if self.is_mnist() else 128
