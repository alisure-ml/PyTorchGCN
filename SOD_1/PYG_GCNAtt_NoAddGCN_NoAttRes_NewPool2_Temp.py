...
"""
ckpt:./ckpt/PYG_GCNAtt_NoAddGCN_NoAttRes_NewPool2/12
Total param: 43975617 lr_s=[[0, 5e-05], [20, 5e-06]]
x_gcn = self.conv_gcn(x_gcn)
res = x_gcn * res
2020-08-29 08:47:25 E:28, Train sod-mae-score=0.0089-0.9863 gcn-mae-score=0.0409-0.9205 loss=300.7986(2132.5600+43.7713)
2020-08-29 08:47:25 E:28, Test  sod-mae-score=0.0371-0.8820 gcn-mae-score=0.0729-0.7490 loss=0.3276(0.1788+0.1488)

ckpt:./ckpt/PYG_GCNAtt_NoAddGCN_NoAttRes_NewPool2/20
Total param: 43975617 lr_s=[[0, 5e-05], [20, 5e-06]]
x_gcn = self.conv_gcn(x_gcn)
x_gcn = torch.sigmoid(x_gcn)
res = x_gcn * res
...
ckpt:./ckpt/PYG_GCNAtt_NoAddGCN_NoAttRes_NewPool2/32
Total param: 43975617 lr_s=[[0, 5e-05], [20, 5e-06]]
x_gcn = self.conv_gcn(x_gcn)
x_gcn = torch.sigmoid(x_gcn)
res = x_gcn * res
2020-09-01 03:10:55 E:29, Train sod-mae-score=0.0091-0.9859 gcn-mae-score=0.0407-0.9211 loss=305.7100(2186.3686+43.5366)
2020-09-01 03:10:55 E:29, Test  sod-mae-score=0.0380-0.8812 gcn-mae-score=0.0742-0.7472 loss=0.3311(0.1828+0.1483)
"""
