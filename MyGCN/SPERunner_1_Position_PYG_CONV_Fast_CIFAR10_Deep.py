...
class CONVNet(nn.Module):
    ...
    def __init__(self, layer_num=6, out_dim=None, pretrained=False):  # 6, 13
        super().__init__()
        if out_dim:
...
class MyGCNNet(nn.Module):
    ...
    def __init__(self, conv_layer_num=6, which=0, has_bn=False, normalize=False, residual=False, improved=False,
                 concat=False, hidden_dims1=[128, 128], hidden_dims2=[128, 128, 128, 128], pretrained=False):
        super().__init__()
...
class RunnerSPE(object):
    ...
    def __init__(self, data_root_path='/mnt/4T/Data/cifar/cifar-10', down_ratio=1, concat=False, which=0,
                 ...
                 hidden_dims1=[128, 128], hidden_dims2=[128, 128, 128, 128], pretrained=False):
...
if __name__ == '__main__':
    ...
    if _is_sgd:
        ...
        # _lr = [[0, 0.05], [50, 0.005], [100, 0.0005]]
        # _lr = [[0, 0.02], [50, 0.002], [100, 0.0002]]
        # _lr = [[0, 0.0256], [50, 0.00256], [100, 0.000256]]
    else:
    ...
    _root_ckpt_dir = "./ckpt2/dgl/1_Position_PYG_CONV_Fast_CIFAR10/{}_{}_{}_{}_{}_{}_{}".format(
        _which, _is_sgd, _sp_size,  _down_ratio, _conv_layer_num, pool_name, _padding)
