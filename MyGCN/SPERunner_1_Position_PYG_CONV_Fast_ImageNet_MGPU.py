...
class Param(object):
    ...
    _root_ckpt_dir = "./ckpt2/dgl/1_Position_PYG_CONV_Fast_ImageNet_Block/{}_{}_{}_{}_{}_data_arg".format(
...
if __name__ == '__main__':
    ...
    runner.load_model("./ckpt2/dgl/1_Position_PYG_CONV_Fast_ImageNet_Block/True_4_4_23_mean_mean_pool_data_arg/epoch_5.pkl")
    runner.train(Param.epochs, start_epoch=3)
