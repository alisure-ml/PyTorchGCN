...
if __name__ == '__main__':
    """
    # 原始:数据增强+LR
    GCN          2020-04-10 16:38:00 Epoch: 99, lr=0.0001, Train: 0.6296/1.0195 Test: 0.6161/1.0735
    GraphSageNet 2020-04-10 17:20:39 Epoch: 98, lr=0.0001, Train: 0.6729/0.9034 Test: 0.6481/0.9915
    """
    # _gcn_model = GCNNet
