...
class MyDataset(Dataset):
    ...
    def __init__(self, data_root_path='D:\\data\\ImageNet\\ILSVRC2015\\Data\\CLS-LOC',
                 is_train=True, image_size=64, sp_size=5, train_split="train", test_split="val_new"):
        super().__init__()
        ...
        _transform = transforms.Compose([transforms.RandomCrop(64, padding=8),
...
class MyGCNNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.model_conv = CONVNet(in_dim=3, hidden_dims=["64", "64", "M", "128", "128"])
        self.model_gnn1 = GATNet1(in_dim=128, hidden_dims=[40, 40])
        self.model_gnn2 = GATNet2(in_dim=40, hidden_dims=[80, 80, 80, 80], n_classes=200)
        pass
...
if __name__ == '__main__':
    ...
    GatedGCNNet  1637832  64 2020-05-08 13:26:02 Epoch:69,lr=0.0010,Train:0.5654-0.8196/1.6951 Test:0.5079-0.7705/2.0283
    GATNet       2652328  64 2020-05-12 08:24:16 Epoch:94,lr=0.0001,Train:0.6958-0.9016/1.1421 Test:0.5434-0.7884/1.9339
    ...
    _root_ckpt_dir = "./ckpt2/dgl/4_DGL_CONV-ImageNet-Tiny/{}".format("GATNet")
    _batch_size = 64
    _image_size = 64
    _sp_size = 4
