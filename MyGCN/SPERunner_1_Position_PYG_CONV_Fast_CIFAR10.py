...
class SAGENet1(nn.Module):
    ...
    def forward(self, data):
        hidden_nodes_feat = self.embedding_h(data.x)
        for gcn, bn, pos in zip(self.gcn_list, self.bn_list, self.position_list):
            h_in = hidden_nodes_feat
...
1_True_2_2_13_mean_mean_pool     2020-09-22 19:02:36 Epoch:134, Train:0.9751-0.9998/0.0754 Test:0.9063-0.9965/0.3305
1_True_2_2_13_mean_mean_pool Att 2020-09-22 19:02:36 Epoch:111, Train:0.9684-0.9998/0.0950 Test:0.9089-0.9967/0.3060

1_True_4_1_6_mean_mean_pool  Att + SGD 2020-09-23 01:27:14 Epoch:133, Train:0.9652-0.9998/0.1111 Test:0.8854-0.9956/0.3725
1_True_2_2_13_mean_mean_pool Att + SGD 2020-09-22 19:02:36 Epoch:144, Train:0.9829-0.9999/0.0562 Test:0.9039-0.9972/0.3407
1_True_2_2_13_mean_mean_pool Att + ReLU SGD 09-23 07:32:00 Epoch:105, Train:0.9648-0.9997/0.1084 Test:0.9069-0.9968/0.3037
1_True_2_2_13_mean_mean_pool Att + ReLU Adam 9-23 05:28:13 Epoch: 91, Train:0.9927-1.0000/0.0225 Test:0.9004-0.9966/0.5217
1_True_2_2_13_mean_mean_pool Att * ReLU SGD 2Linear :08:25 Epoch:149, Train:0.9859-1.0000/0.0481 Test:0.9121-0.9967/0.3270
1_True_4_1_6_mean_mean_pool  Att * ReLU SGD 2Linear
1_False_2_2_13_mean_max_pool Att * ReLU Adam 2Linear mean_max_pool 
1_False_2_2_13_mean_max_pool Att * ReLU SGD 2Linear mean_max_pool  594112 0.01
1_False_2_2_13_mean_max_pool Att * ReLU SGD 2Linear mean_mean_pool 594112 0.01
"""
