...
class CONVNet(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self._vv = 20  # 23
        self.features = vgg13_bn(pretrained=True).features[0: self._vv]
    ...
    def forward(self, x):
        ...
        block_3 = self.features[14: self._vv](block_2_max)
...
class SODNet(nn.Module):
    ...
    def __init__(self, conv1_feature_num, conv2_feature_num, sod_gcn1_feature_num, sod_gcn2_feature_num, out=1):
        super().__init__()
        ...
        self.cat_sod_gcn = ConvBlock(sod_gcn1_feature_num, cout=conv2_feature_num, ks=3)
...
if __name__ == '__main__':
    ...
    _sp_size, _down_ratio, _model_name = 4, 4, "GCNNet-C2PC2PC2"

    _name = "E2E2-BS1-{}_{}_{}_lr0001".format(_model_name, _is_sgd, _has_mask)
