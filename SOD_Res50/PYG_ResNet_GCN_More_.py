...
class MyGCNNet(nn.Module):
    ...
    def forward(self, x, batched_graph, batched_pixel_graph):
        ...
        merge = self.deep_pool3(merge, feature2, x_gcn=sod_gcn2_feature)  # A + F
        merge = self.deep_pool2(merge, feature1, x_gcn=sod_gcn2_feature)  # A + F
...
"""
Total param: 61849793 lr_s=[[0, 5e-05], [20, 5e-06]]
2020-08-27 10:09:00 E:28, Train sod-mae-score=0.0107-0.9838 gcn-mae-score=0.0644-0.8792 loss=307.4000(2500.7241+28.6638)
2020-08-27 10:09:00 E:28, Test  sod-mae-score=0.0384-0.8788 gcn-mae-score=0.0851-nan loss=0.3448(0.2055+0.1393)
"""
...
if __name__ == '__main__':
    ...
    _root_ckpt_dir = "./ckpt/PYG_ResNet_GCN_More/{}".format(_gpu_id)
