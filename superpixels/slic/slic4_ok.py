...
class SLIC(object):
    ...
    def enforceConnectivity(self):
        ...
        for cluster in self.clusters:
            ...
            while bfsQueue:
                ...
                for _p in (
                (pixel[0] - 1, pixel[1]), (pixel[0] + 1, pixel[1]), (pixel[0], pixel[1] - 1), (pixel[0], pixel[1] + 1)):
            ...
            while pixelSet:
                ...
                while (bfsQueue):
                    ...
                    for _p in ((pixel[0] - 1, pixel[1]), (pixel[0] + 1, pixel[1]), (pixel[0], pixel[1] - 1),
                               (pixel[0], pixel[1] + 1)):
    ...
    def execute(self, iterations, labWeight=0.5, isBordered=True, result_path=None):
        ...
        for i in range(iterations):
            ...
            self.saveImage(os.path.join(result_path, name), False)
...
if __name__ == '__main__':
    processor = SLIC("input\\1.jpg", 5500, 10)
    processor.execute(5, 0.2, False, result_path=Tools.new_dir("result4"))
    print("Hello World :^)")
    pass
